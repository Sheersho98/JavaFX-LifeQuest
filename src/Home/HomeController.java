...
//            stage.initOwner();
            stage.show();
            stage.setTitle("Life Quest Manager: Start Activity");
...
//            stage.show();
            ...
            Stage stage = new Stage();
            stage.setScene(secondScene);
            stage.setTitle("Life Quest Manager: New Activity");
...
//            stage.close();
            ...
            Stage stage = new Stage();
            stage.setScene(secondScene);
            stage.setTitle("Life Quest Manager: Delete Activity");
...
//        }
        if (event.getSource() == btnOut) {
            ...
            stage.setScene(scene);
            stage.setTitle("Life Quest Manager");
        ...
        if (event.getSource() == btnTable) {
            ...
            Stage stage = new Stage();
            stage.setScene(secondScene);
            stage.setTitle("Life Quest Manager: Activity View");
            stage.getIcons().add(new Image(getClass().getResourceAsStream("/images/sword.png")));
            stage.show();
        }
        if (event.getSource() == btnGrp) {
...
//            stage.show();
            ...
            Stage stage = new Stage();
            stage.setScene(secondScene);
            stage.setTitle("Life Quest Manager: Group Activity");
            stage.getIcons().add(new Image(getClass().getResourceAsStream("/images/teamwork.png")));
            stage.show();
        }
        if (event.getSource() == btnMap){
            String url = "C:\\Users\\USER\\Desktop\\Class Improvement\\ProjectUI1\\ProjectUI1\\src\\googlemap.html";
